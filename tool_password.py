...
if __name__ == "__main__":
    ...
    print("[+] Using zxcvbn library to assess password security")
    ...
    if len(sys.argv) == 2:
        ...
        print('Usage: python tool_password.py <file> (for a file containing passwords) or \
            \npython tool_password.py (for a single password.)')
